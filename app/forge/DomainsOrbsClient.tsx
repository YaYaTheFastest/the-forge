...
export default function DomainsOrbsClient({ initialDomains }: Props) {
  const [domains, setDomains] = useState<Domain[]>(initialDomains.length > 0 ? initialDomains : fallbackDomains);
        ...
        <Link key={d.slug} href={d.href} className="group">
          <motion.div
            ...
            className={`
              ...
              ${d.color === 'gray' ? 'border-gray-500/30 hover:shadow-[0_0_40px_rgba(107,114,128,0.25)]' : ''}
            `}
          >
